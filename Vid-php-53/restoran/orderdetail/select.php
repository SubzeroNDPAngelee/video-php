...
<?php 
    ...
    $jumlahdata = $db->rowCOUNT("SELECT idorderdetail FROM vorederdetail");
    ...
    $sql = "SELECT * FROM vorederdetail ORDER BY idorderdetail DESC LIMIT $mulai,$banyak";

    if (isset($_POST['simpan'])) {
        $tawal = $_POST['tawal'];
        $takhir = $_POST['takhir'];
        $sql = "SELECT * FROM vorederdetail WHERE tglorder BETWEEN '$tawal' AND '$takhir'";
        //echo $sql;
    }
